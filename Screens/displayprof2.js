...
export default function DisplayProf2 ({navigation}) {
  ...
  useEffect(() => {
    ...
    axios.post('http://average-cape-dove.cyclic.app/displayprof',{data3},{maxContentLength: 1000000})
    .then(response => {
...
axios.post('http://average-cape-dove.cyclic.app/elitecheck',{datanew},{maxContentLength: 1000000})
.then(response => {
